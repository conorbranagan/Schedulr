 ...
 */
	Configure::write('Security.salt', 'ASFLKJAKLVNMn21490890r8ASE*(WvVMNMASD498q309FDSF$#5)');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '349857230894712903233463243216589790');
